...
public class CustomReport implements IReporter
{
    ...
    private String ffX_Logo = "<center><a data-v-0310a31a=\"\" href=\"https://mleseducation.com/\">\n"
    		+ "<img data-v-0310a31a=\"\" src=\"https://www.mileseducation.com/newImages/MilesEducationWebsite-2024/logo.webp\" alt=\"Miles Education\" style=\"background-color:white;padding:20px;height:60px;width:200px;\">\n"
    		+ "</a></center>"; 
                               ...
                               String outputDirectory) 
    {
      ...
      //  CopyReportToCustomeFolder(outputDirectory+"\\"+outFilename.toString());
        ...
        try 
        {
			SendReportInMail(outputDirectory+"\\"+outFilename.toString(),filePreffix);
		} catch (IOException e) 
        {
       ...
       */
        ...
        // ZAPI Token for jenkins: i7mqJeqZw3cVveDp2uKE3421
    ...
    {
        writer.print("<body>");
        writeReportTitle( "WebApp Test Automation Report" );
        writeSuiteSummary();
    ...
    protected void WriteTotalExecutionTimeInMinutes(double dur)
    {
    ...
    protected void writeSuiteSummary()
    {
        ...
        writer.print("<th>Time in Seconds</th>");
        ...
        if (millisecondsToSeconds(totalDuration)>=60)
        {
        	 writer.print("<tr>");
             writer.print("<th>Total execution time in Minutes</th>");
             writeTableHeader( decimalFormat.format(secondsToMinutes((long) millisecondsToSeconds(totalDuration))) +ReturnRightNoun(secondsToMinutes((long) millisecondsToSeconds(totalDuration))), "num");
             writer.print("<th colspan=\"4\"></th>");
             writer.print("</tr>");	
        	//WriteTotalExecutionTimeInMinutes(millisecondsToSeconds(totalDuration));
    ...
    /**
     * 
     * returns the right Noun while displaying Total Execution time on Report
     */
    protected String ReturnRightNoun(double num)
    {
        ...
        if (!classResults.isEmpty()) {
            ...
            for ( ClassResult classResult : classResults ) {
                ...
                for ( MethodResult methodResult : classResult.getMethodResults() )
                {
                    ...
                    String methodDesc = Utils.escapeHtml(aResult.getMethod().getDescription());
...
/**
 * This Method prints the cause of failure 
 * basically the Exception Message
 * @param throwable
 */
    protected void writeStackTrace(Throwable throwable)
    {
        writer.print("<div class=\"stacktrace\">");
        writer.print(Utils.longStackTrace(throwable, true));//   stackTrace(throwable ,true)[0]);
        writer.print("</div>");
    }
...
/**
 * This Method will Convert Seconds to Minutes and displays on the Report
 * 
 * @param seconds
 * @return
 */
    protected double secondsToMinutes(long seconds)
    {
     ...
     * Rest is Google's Headache :) 
     * 
     * @param SourcLocation
     */
    protected void CopyReportToQAFolderInGoogleDrive(String SourcLocation)
    {

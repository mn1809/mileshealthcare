...
//	 String ExpectedEligibilityType = "Eligibility not done";
	...
	//	System.out.println();
		 ...
		 {
			homeObj = loginObj.login("manoj.hr.universityexpert@mileseducation.com",MilesUtilities.DecryptPass("MTIzNDEyMzQ="));
			 //MTIzNDEyMzQ=
...
//@Test (priority = 1, description = "U9+ Application Submitted Process")
...

{
	...
	ATSU.U9PlusBucket();
	Thread.sleep(2000);
	ATSU.UPPlusReuploading(); 
	Thread.sleep(5000);
	ATSU.U9VerifyDocuments();
	
}

//@Test (priority = 2, description= "U9+ Application Initiated")
...
public void VerifyU9plusStage2Bucket() throws InterruptedException, AWTException
{
	...
	Thread.sleep(5000);
	ATSU.U9PlusAddingMOI();

}

//@Test (priority = 3, description= "U10 Upload Offer Letter")

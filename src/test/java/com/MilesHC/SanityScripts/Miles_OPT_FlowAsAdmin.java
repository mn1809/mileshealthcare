...
@Test(description = "Verify Admin Can Enter to Miles Requirement as OPT Module")
public void EntireingtoMilesRequirementOPTModule() throws InterruptedException

{
	...
	driver.findElement(By.className("dropdown-toggle")).click();
	Thread.sleep(2);
	driver.findElement((By.xpath("//*[contains(@class, 'dropdown-item o_app focus')]"))).click();
	Thread.sleep(5);
